...
macro(append_lib_names_to_list _lib_names_list _lib_names)
    foreach (_lib_filename ${${_lib_names}})
...
if (QT_STATIC_BUILD)
    ...
    if (MSVC)
        ...
        append_lib_names_to_list(EXTRA_LIBS_NAMES SQLITE_LIBRARIES)
        append_lib_names_to_list(EXTRA_LIBS_NAMES ZLIB_LIBRARIES)
    else ()
        list(APPEND EXTRA_LIBS_NAMES ${LIBXML2_LIBRARIES})
    endif ()
    if (NOT USE_SYSTEM_MALLOC)
        list(APPEND EXTRA_LIBS_NAMES bmalloc)
    endif ()
    if (ENABLE_XSLT)
        list(APPEND EXTRA_LIBS_NAMES ${LIBXSLT_LIBRARIES})
    endif ()
    if (USE_LIBHYPHEN)
